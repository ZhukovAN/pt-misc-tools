package com.ptsecurity.appsec.vijn.utils.ci.integration.plugin.jenkins.actions.AstJobMultipleResults

import com.ptsecurity.appsec.vijn.utils.ci.integration.Resources

st = namespace('jelly:stapler')

def latestResults = from.getLatestBuildScanResults(10)
if (null == latestResults || latestResults.isEmpty()) return

div(class: 'test-trend-caption') {
    text(Resources.i18n_vijn_result_charts_trend_label())
}
...
script(src: "${rootURL}/plugin/vijn-jenkins-plugin/webjars/echarts/echarts.common.min.js")
